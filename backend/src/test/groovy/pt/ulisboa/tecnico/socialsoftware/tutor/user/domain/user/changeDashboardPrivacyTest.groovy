...
class changeDashboardPrivacyTest extends Specification {
    ...
    def "make a Dashboard private"() {
        ...
        def result = userService.changeDashBoardPrivacy(student.getId())

        then:
        result.isDashboardPrivacy();
    }

    def "You change DashBoardPrivacy of a Student who has it privste"() {
        when: "You change the privacy of DashBoard"
        def result = userService.changeDashBoardPrivacy(student2.getId())
    ...
    def "change privacy on a null user"() {
        when: "You change the privacy of DashBoard"
        userService.changeDashBoardPrivacy(null)
    ...
    def "changing privacy but user is not student"(){
        when: "You change the privacy of DashBoard"
        userService.changeDashBoardPrivacy(teacher.getId())
